...
| T25 | 2026-08-13 | Point/ellipse sky-target impostor RENDER never eyeballed (ring widening + tracked-DSO flows verified 08-03/08-10; no shot of the point/ellipse treatments themselves) | ASTRO_ENGINE_PLAN.md:166 + audit finding C2/D8 | CLOSED 2026-08-13 (Phase 8a browser pass) — POINT eyeballed on the new GC target (broken-hairline ring + faint point, verify-shots/phase8a-09-gc-reticle-crop.png) · ELLIPSE eyeballed on M31 at real 178′×70′ extents + widened ring (phase8a-10-m31-ellipse-crop.png), both in FPV headed Chrome |
