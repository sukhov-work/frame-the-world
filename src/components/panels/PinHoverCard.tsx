 ...
 * hover/preview follow-up lands here). The orchestrator mirrors the hovered pin + its head's
 * projected screen position into the pins store at low cadence; the card is pointer-events-none
 * chrome — the CLICK still belongs to the globe (it opens the pin as the placed camera view).
