...
half is reduced to a one-command recipe + a flag flip.** Full verdict: `.claude/claude-docs/archive/DNIPRO_SLICE0_SPIKE.md` *(moved to `archive/` in the 2026-07-15 docs reorg; path corrected 2026-09-06)*.
