...
**Next step: PhotoPills user-guide DEEP REVIEW + sun/moon/MW QoL batch (OWNER ORDERS 2026-08-14 — `mem:project/owner-orders-2026-08-14-qol-batch`: sun/moon/MW planning FIRST, astro/DSO only after mobile fully solved + QoL done; scrubber v2 all-bands/charts/infinite-drag · FPV shoot-this-frame suggestions · my-location→FPV button both shells · Space=ascend) → 8b re-scoped by that research → M3 (mobile surfaces of 8a/8b). M2 DONE 2026-08-14 (FPV touch: joystick walk seam `fpvWalkInput` + pinch-FOV + ⤒/⤓ nudges + HUD row + wake lock + minimap on /m; pivot invariant re-verified on touch 0.000 m; phone-viewport browser-verified; `mem:project/wip-2026-08-13-m2-fpv-touch`). M1 DONE 2026-08-13 (phone-viewport browser-verified; `mem:project/wip-2026-08-13-m1-mobile-planning`). DONE
